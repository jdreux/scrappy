...
var G__4740 = null;
var G__4740__2 = (function (self__,k){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k);
});
var G__4740__3 = (function (self__,k,not_found){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k,not_found);
});
...
;
jQuery.prototype.apply = (function (self__,args4739){return self__.call.apply(self__,[self__].concat(args4739.slice()));
});
...
var hide__delegate = function ($elem,p__4741){var vec__4743 = p__4741;var speed = cljs.core.nth.call(null,vec__4743,0,null);var on_finish = cljs.core.nth.call(null,vec__4743,1,null);return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__4741 = null;if (arguments.length > 1) {
...
var show__delegate = function ($elem,p__4745){var vec__4747 = p__4745;var speed = cljs.core.nth.call(null,vec__4747,0,null);var on_finish = cljs.core.nth.call(null,vec__4747,1,null);return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__4745 = null;if (arguments.length > 1) {
...
var toggle__delegate = function ($elem,p__4749){var vec__4751 = p__4749;var speed = cljs.core.nth.call(null,vec__4751,0,null);var on_finish = cljs.core.nth.call(null,vec__4751,1,null);return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__4749 = null;if (arguments.length > 1) {
...
var fade_out__delegate = function ($elem,p__4753){var vec__4755 = p__4753;var speed = cljs.core.nth.call(null,vec__4755,0,null);var on_finish = cljs.core.nth.call(null,vec__4755,1,null);return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__4753 = null;if (arguments.length > 1) {
...
var fade_in__delegate = function ($elem,p__4757){var vec__4759 = p__4757;var speed = cljs.core.nth.call(null,vec__4759,0,null);var on_finish = cljs.core.nth.call(null,vec__4759,1,null);return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__4757 = null;if (arguments.length > 1) {
...
var slide_up__delegate = function ($elem,p__4761){var vec__4763 = p__4761;var speed = cljs.core.nth.call(null,vec__4763,0,null);var on_finish = cljs.core.nth.call(null,vec__4763,1,null);return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__4761 = null;if (arguments.length > 1) {
...
var slide_down__delegate = function ($elem,p__4765){var vec__4767 = p__4765;var speed = cljs.core.nth.call(null,vec__4767,0,null);var on_finish = cljs.core.nth.call(null,vec__4767,1,null);return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__4765 = null;if (arguments.length > 1) {
...
var closest__delegate = function ($elem,selector,p__4769){var vec__4771 = p__4769;var context = cljs.core.nth.call(null,vec__4771,0,null);return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__4769 = null;if (arguments.length > 2) {
...
jayq.core.preprocess_request = (function preprocess_request(p__4775){var map__4777 = p__4775;var map__4777__$1 = ((cljs.core.seq_QMARK_.call(null,map__4777))?cljs.core.apply.call(null,cljs.core.hash_map,map__4777):map__4777);var request = map__4777__$1;var contentType = cljs.core.get.call(null,map__4777__$1,new cljs.core.Keyword(null,"contentType","contentType",624772805));var data = cljs.core.get.call(null,map__4777__$1,new cljs.core.Keyword(null,"data","data",1016980252));var ct = jayq.core.__GT_content_type.call(null,contentType);return (function (p1__4774_SHARP_){if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_.call(null,ct)))
...
}).call(null,(function (p1__4773_SHARP_){if(cljs.core.truth_(ct))
...
;
jayq.core.xhr = (function xhr(p__4778,content,callback){var vec__4780 = p__4778;var method = cljs.core.nth.call(null,vec__4780,0,null);var uri = cljs.core.nth.call(null,vec__4780,1,null);var params = cljs.core.clj__GT_js.call(null,cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"type","type",1017479852),clojure.string.upper_case.call(null,cljs.core.name.call(null,method)),new cljs.core.Keyword(null,"data","data",1016980252),cljs.core.clj__GT_js.call(null,content),new cljs.core.Keyword(null,"success","success",3441701749),callback], true));return jQuery.ajax(uri,params);
});
/**
...
var unbind__delegate = function ($elem,ev,p__4781){var vec__4783 = p__4781;var func = cljs.core.nth.call(null,vec__4783,0,null);return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__4781 = null;if (arguments.length > 2) {
...
var on__delegate = function ($elem,events,p__4785){var vec__4787 = p__4785;var sel = cljs.core.nth.call(null,vec__4787,0,null);var data = cljs.core.nth.call(null,vec__4787,1,null);var handler = cljs.core.nth.call(null,vec__4787,2,null);return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__4785 = null;if (arguments.length > 2) {
...
var one__delegate = function ($elem,events,p__4789){var vec__4791 = p__4789;var sel = cljs.core.nth.call(null,vec__4791,0,null);var data = cljs.core.nth.call(null,vec__4791,1,null);var handler = cljs.core.nth.call(null,vec__4791,2,null);return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__4789 = null;if (arguments.length > 2) {
...
var off__delegate = function ($elem,events,p__4793){var vec__4795 = p__4793;var sel = cljs.core.nth.call(null,vec__4795,0,null);var handler = cljs.core.nth.call(null,vec__4795,1,null);return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__4793 = null;if (arguments.length > 2) {
