...
clojure.string.split_with_empty_regex = (function split_with_empty_regex(s,limit){if((function (){var or__3943__auto__ = (limit <= 0);if(or__3943__auto__)
...
{var pred__4835 = cljs.core._EQ_;var expr__4836 = limit;if(pred__4835.call(null,1,expr__4836))
...
{var ch = cljs.core.get.call(null,s,(index - 1));if((function (){var or__3943__auto__ = cljs.core._EQ_.call(null,ch,"\n");if(or__3943__auto__)
{return or__3943__auto__;
} else
...
{var ch = s.charAt(index);var temp__4090__auto___4842 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___4842))
{var replacement_4843 = temp__4090__auto___4842;buffer.append([cljs.core.str(replacement_4843)].join(''));
} else
{buffer.append(ch);
}
{
