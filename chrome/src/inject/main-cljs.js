...
scrappy.core.click = function() {
  var click = null;
  var click__1 = function($el) {
    return $el.click()
  };
  var click__2 = function($el, handler) {
    return $el.click(handler)
  };
...
jayq.core.document_ready.call(null, function() {
  ...
  jayq.core.on.call(null, jayq.core.$.call(null, ".key button"), new cljs.core.Keyword(null, "click", "click", 1108654330), function(e) {
    jayq.core.remove_class.call(null, jayq.core.$.call(null, ".scrappy-hover, .scrappy-matched"), "scrappy-hover scrappy-matched");
    return scrappy.core.hover.call(null, scrappy.core.jq_not.call(null, jayq.core.$.call(null, "body *:visible"), ".scrappy, .scrappy *"), function(e__$1) {
      var $el = jayq.core.$.call(null, e__$1.currentTarget);
      var classes = cljs.core.filter.call(null, function($el) {
        return function(p1__4980_SHARP_) {
          var or__3943__auto__ = cljs.core.not_EQ_.call(null, "scrappy-matched", p1__4980_SHARP_);
          if(or__3943__auto__) {
            return or__3943__auto__
          }else {
      ...
      var tag_name = clojure.string.lower_case.call(null, jayq.core.prop.call(null, $el, "tagName"));
      var selector = clojure.string.join.call(null, ".", cljs.core.into.call(null, cljs.core.PersistentVector.fromArray([tag_name], true), cljs.core.remove.call(null, cljs.core.PersistentHashSet.fromArray(["scrappy-hover", null], true), classes)));
      var matched = scrappy.core.jq_not.call(null, jayq.core.$.call(null, selector), ".scrappy, .scrappy *");
  ...
  jayq.core.on.call(null, jayq.core.$.call(null, document), new cljs.core.Keyword(null, "click", "click", 1108654330), new cljs.core.Keyword(null, ".scrappy-hover", ".scrappy-hover", 1921094989), function(e) {
    var matched = jayq.core.$.call(null, jayq.core.text.call(null, scrappy.core.$current));
    ...
    var seq__4985 = cljs.core.seq.call(null, matched);
    var chunk__4986 = null;
    var count__4987 = 0;
    var i__4988 = 0;
    while(true) {
      if(i__4988 < count__4987) {
        var el = cljs.core._nth.call(null, chunk__4986, i__4988);
        scrappy.core.log.call(null, el);
        jayq.core.append.call(null, scrappy.core.$matches_pre, [cljs.core.str("\x3cp\x3e"), cljs.core.str(jayq.core.text.call(null, jayq.core.$.call(null, el))), cljs.core.str("\x3c/p\x3e")].join(""));
        ...
        var temp__4092__auto__ = cljs.core.seq.call(null, seq__4985);
        if(temp__4092__auto__) {
          var seq__4985__$1 = temp__4092__auto__;
          if(cljs.core.chunked_seq_QMARK_.call(null, seq__4985__$1)) {
            ...
            var el = cljs.core.first.call(null, seq__4985__$1);
            scrappy.core.log.call(null, el);
            jayq.core.append.call(null, scrappy.core.$matches_pre, [cljs.core.str("\x3cp\x3e"), cljs.core.str(jayq.core.text.call(null, jayq.core.$.call(null, el))), cljs.core.str("\x3c/p\x3e")].join(""));
  ...
  return scrappy.core.click.call(null, scrappy.core.$match_button, function(e) {
    var key = jayq.core.val.call(null, jayq.core.$.call(null, ".matches input"));
    var values = jayq.core.$.call(null, jayq.core.text.call(null, scrappy.core.$current));
    jayq.core.prevent.call(null, e);
    ...
    scrappy.core.log.call(null, cljs.core.map.call(null, function(p1__4981_SHARP_, p2__4982_SHARP_) {
      return[cljs.core.str("\x3cli\x3e"), cljs.core.str(p1__4981_SHARP_), cljs.core.str(": "), cljs.core.str(cljs.core.count.call(null, p2__4982_SHARP_)), cljs.core.str(" matches\x3c/li\x3e")].join("")
    ...
    return jayq.core.html.call(null, scrappy.core.$results_list, clojure.string.join.call(null, cljs.core.map.call(null, function(p1__4983_SHARP_, p2__4984_SHARP_) {
      return[cljs.core.str("\x3cli\x3e"), cljs.core.str(p1__4983_SHARP_), cljs.core.str(": "), cljs.core.str(cljs.core.count.call(null, p2__4984_SHARP_)), cljs.core.str(" matches\x3c/li\x3e")].join("")
    }, cljs.core.keys.call(null, cljs.core.deref.call(null, scrappy.core.matches)), cljs.core.vals.call(null, cljs.core.deref.call(null, scrappy.core.matches)))))
  })
});
